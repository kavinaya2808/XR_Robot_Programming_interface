...
namespace Unity.Robotics.Core
{
    public static class Clock
    {
        public enum ClockMode
        {
            ...
            UnityUnscaled,
            // Real time delta since the Unix Epoch (1/1/1970 @ midnight) - Best for ROS compatibility
            UnixEpoch,
        }
        ...
        static double SecondsSinceUnixEpoch => (DateTime.UtcNow - k_UnixEpoch).TotalSeconds;
        ...
        public static double FrameStartTimeInSeconds
        {
            get
            {
                return Mode switch
                {
                    ...
                    ClockMode.UnixEpoch => k_StartTimeEpochSeconds + Time.unscaledTimeAsDouble,
